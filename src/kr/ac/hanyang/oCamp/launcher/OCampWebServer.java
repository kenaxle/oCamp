...
public class OCampWebServer {
    ...
    public OCampWebServer(ManagementContext managementContext) {
    ...
    public OCampWebServer(ManagementContext managementContext, int port) {
        this(managementContext, port, "brooklyn.war");
    }

    public OCampWebServer(ManagementContext managementContext, int port, String warUrl) {
    ...
    public OCampWebServer setPort(Object port) {
        if (getActualPort()>0)
    ...
    public OCampWebServer setHttpsEnabled(Boolean httpsEnabled) {
     ...
     * cf deploy("/", url) */
    public OCampWebServer setWar(String url) {
        this.war = url;
        return this;
    }
     ...
     * cf deploy(path, url) */
    public OCampWebServer addWar(String path, String warUrl) {
        addWar(new WebAppContextProvider(path, warUrl));
        return this;
    }

    public OCampWebServer addWar(WebAppContextProvider contextProvider) {
    ...
    public OCampWebServer setBindAddress(InetAddress address) {
        bindAddress = address;
        return this;
    }
     ...
     */
    public OCampWebServer setPublicAddress(InetAddress address) {
        publicAddress = address;
        return this;
    }

    /** @deprecated use setAttribute */
    public OCampWebServer addAttribute(String field, Object value) {
    ...
    public OCampWebServer setAttribute(String field, Object value) {
        attributes.put(field, value);
        return this;
    }
    
    public <T> OCampWebServer configure(ConfigKey<T> key, T value) {
    ...
    public OCampWebServer putAttributes(Map newAttrs) {
