 ...
 * @param <T> */
public class OCampLauncher<T> {

    private static final Logger LOG = LoggerFactory.getLogger(OCampLauncher.class);
 ...
 //---------------------------------------------------------------------------------
  ...
  //--------------------------------------------------------------------------------- 
    ...
    public static OCampLauncher newInstance(){
    	return new OCampLauncher();
    }
...
//    private String localBrooklynPropertiesFile;
     ...
     */
    public OCampLauncher<T> webconsole(boolean startWebApps) {
        this.startWebApps = startWebApps;
        return this;
    }

    public OCampLauncher<T> installSecurityFilter(Boolean val) {
     ...
     */ 
    public OCampLauncher<T> webconsolePort(int port) {
     ...
     */
    public OCampLauncher<T> webconsolePort(String port) {
     ...
     */ 
    public OCampLauncher<T> webconsolePort(PortRange port) {
        this.port = port;
        return this;
    }
     ...
     */ 
    public OCampLauncher<T> webconsoleHttps(Boolean useHttps) {
     ...
     */ 
    public OCampLauncher<T> bindAddress(InetAddress bindAddress) {
     ...
     */
    public OCampLauncher<T> publicAddress(InetAddress publicAddress) {
     ...
     */ 
    public OCampLauncher<T> webServerFlags(Map<String,?> webServerFlags) {
     ...
     */
    public OCampLauncher<T> webapp(String contextPath, String warUrl) {
     ...
     */
    public OCampLauncher<T> webapp(WebAppContextProvider contextProvider) {
        webApps.add(contextProvider);
        return this;
    }

    public OCampLauncher<T> ignoreWebErrors(boolean ignoreWebErrors) {
        this.ignoreWebErrors = ignoreWebErrors;
        return this;
    }

    public OCampLauncher<T> stopWhichAppsOnShutdown(StopWhichAppsOnShutdown stopWhich) {
        this.stopWhichAppsOnShutdown = stopWhich;
        return this;
    }

    public OCampLauncher<T> customizeManagement(Function<ManagementContext,Void> customizeManagement) {
        this.customizeManagement = customizeManagement;
        return this;
    }

    public OCampLauncher<T> shutdownOnExit(boolean val) {
     ...
     */
    public OCampLauncher<T> shutdownHandler(ShutdownHandler shutdownHandler) {
...
//    }
    ...
    public OCampLauncher<T> globalBrooklynPropertiesFile(String file) {
        globalBrooklynPropertiesFile = file;
        return this;
    }

    public OCampLauncher<T> localBrooklynPropertiesFile(String file) {
    ...
    public static void main(String [] args){
    	OCampLauncher launcher = (OCampLauncher) OCampLauncher.newInstance()
