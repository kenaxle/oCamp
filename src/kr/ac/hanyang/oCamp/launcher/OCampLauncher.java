...
public class OCampLauncher extends BasicLauncher<OCampLauncher>{
	 private static final Logger LOG = LoggerFactory.getLogger(BrooklynLauncher.class);
	     ...
	     */
	    public OCampLauncher webconsole(boolean startWebApps) {
	        this.startWebApps = startWebApps;
	        return this;
	    }

	    public OCampLauncher installSecurityFilter(Boolean val) {
	     ...
	     */ 
	    public OCampLauncher webconsolePort(int port) {
	     ...
	     */
	    public OCampLauncher webconsolePort(String port) {
	     ...
	     */ 
	    public OCampLauncher webconsolePort(PortRange port) {
	        this.port = port;
	        return this;
	    }
	     ...
	     */ 
	    public OCampLauncher webconsoleHttps(Boolean useHttps) {
	     ...
	     */ 
	    public OCampLauncher bindAddress(InetAddress bindAddress) {
	     ...
	     */
	    public OCampLauncher publicAddress(InetAddress publicAddress) {
	     ...
	     */ 
	    public OCampLauncher webServerFlags(Map<String,?> webServerFlags) {
	     ...
	     */
	    public OCampLauncher webapp(String contextPath, String warUrl) {
	     ...
	     */
	    public OCampLauncher webapp(WebAppContextProvider contextProvider) {
	        webApps.add(contextProvider);
	        return this;
	    }

	    public OCampLauncher ignoreWebErrors(boolean ignoreWebErrors) {
	        this.ignoreWebErrors = ignoreWebErrors;
	        return this;
	    }

	    public OCampLauncher stopWhichAppsOnShutdown(StopWhichAppsOnShutdown stopWhich) {
	        this.stopWhichAppsOnShutdown = stopWhich;
	        return this;
	    }

	    public OCampLauncher customizeManagement(Function<ManagementContext,Void> customizeManagement) {
	        this.customizeManagement = customizeManagement;
	        return this;
	    }

	    public OCampLauncher shutdownOnExit(boolean val) {
	     ...
	     */
	    public OCampLauncher shutdownHandler(ShutdownHandler shutdownHandler) {
	    ...
	    protected void initCamp() {
	        ...
	        campPlatform = new oCampPlatformLauncher()
	                .useManagementContext(getManagementContext())
	                .launch()
	                .getCampPlatform();
	    ...
	    public OCampLauncher globalBrooklynPropertiesFile(String file) {
	        globalBrooklynPropertiesFile = file;
	        return this;
	    }

	    public OCampLauncher localBrooklynPropertiesFile(String file) {
