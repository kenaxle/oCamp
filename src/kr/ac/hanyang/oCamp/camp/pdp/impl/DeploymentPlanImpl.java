 ...
 * </p>
 * <ul>
 *   <li>{@link kr.ac.hanyang.oCamp.camp.pdp.impl.DeploymentPlanImpl#getName <em>Name</em>}</li>
 *   <li>{@link kr.ac.hanyang.oCamp.camp.pdp.impl.DeploymentPlanImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link kr.ac.hanyang.oCamp.camp.pdp.impl.DeploymentPlanImpl#getOrigin <em>Origin</em>}</li>
 *   <li>{@link kr.ac.hanyang.oCamp.camp.pdp.impl.DeploymentPlanImpl#getSourceCode <em>Source Code</em>}</li>
 *   <li>{@link kr.ac.hanyang.oCamp.camp.pdp.impl.DeploymentPlanImpl#getType <em>Type</em>}</li>
 *   <li>{@link kr.ac.hanyang.oCamp.camp.pdp.impl.DeploymentPlanImpl#getArtifacts <em>Artifacts</em>}</li>
...
public class DeploymentPlanImpl extends MinimalEObjectImpl.Container implements DeploymentPlan {
	...
	protected EClass eStaticClass() {
		return PdpPackage.Literals.DEPLOYMENT_PLAN;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PdpPackage.DEPLOYMENT_PLAN__NAME, oldName, name));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PdpPackage.DEPLOYMENT_PLAN__DESCRIPTION, oldDescription, description));
	}
	...
	public void setOrigin(String newOrigin) {
		...
		origin = newOrigin;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PdpPackage.DEPLOYMENT_PLAN__ORIGIN, oldOrigin, origin));
	}
	...
	public void setSourceCode(String newSourceCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PdpPackage.DEPLOYMENT_PLAN__SOURCE_CODE, oldSourceCode, sourceCode));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PdpPackage.DEPLOYMENT_PLAN__TYPE, oldType, type));
	}
	...
	public EList<Artifact> getArtifacts() {
		if (artifacts == null) {
			artifacts = new EObjectResolvingEList<Artifact>(Artifact.class, this, PdpPackage.DEPLOYMENT_PLAN__ARTIFACTS);
		}
		return artifacts;
	}
	...
	public EList<Service> getServices() {
		if (services == null) {
			services = new EObjectResolvingEList<Service>(Service.class, this, PdpPackage.DEPLOYMENT_PLAN__SERVICES);
		}
		return services;
	}
	...
	public EList<Policy> getPolicies() {
		if (policies == null) {
			policies = new EObjectResolvingEList<Policy>(Policy.class, this, PdpPackage.DEPLOYMENT_PLAN__POLICIES);
		}
		return policies;
	}
	...
	public EList<ActionGroup> getActionGroups() {
		if (actionGroups == null) {
			actionGroups = new EObjectResolvingEList<ActionGroup>(ActionGroup.class, this, PdpPackage.DEPLOYMENT_PLAN__ACTION_GROUPS);
		}
		return actionGroups;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PdpPackage.DEPLOYMENT_PLAN__NAME:
				return getName();
			case PdpPackage.DEPLOYMENT_PLAN__DESCRIPTION:
				return getDescription();
			case PdpPackage.DEPLOYMENT_PLAN__ORIGIN:
				return getOrigin();
			case PdpPackage.DEPLOYMENT_PLAN__SOURCE_CODE:
				return getSourceCode();
			case PdpPackage.DEPLOYMENT_PLAN__TYPE:
				return getType();
			case PdpPackage.DEPLOYMENT_PLAN__ARTIFACTS:
				return getArtifacts();
			case PdpPackage.DEPLOYMENT_PLAN__SERVICES:
				return getServices();
			case PdpPackage.DEPLOYMENT_PLAN__POLICIES:
				return getPolicies();
