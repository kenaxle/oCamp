...
import kr.ac.hanyang.oCamp.core.traits.oCampStartable;
	...
	public class OCampEntityManagementUtils { 
		...
		private static List<EntitySpec<?>> artifactList = Lists.newArrayList();
		
		public static Application instantiateApp(AssemblyTemplate template, CampPlatform platform) {
		...
		public static <T extends Application> CreationResult<T,Void> startup(T app) {
		  ...
		  public static class CreationResult<T,U> {
		    ...
		    private static Application create(AssemblyTemplate template, CampPlatform platform) {
		    ...
		    public static List<EntitySpec<?>> createComponentSpecs(
		    ...
		    public static EntitySpec<? extends Application> createApplicationSpec(
		            AssemblyTemplate template,
...
//		        }
		    ...
		    private static boolean allowedToUnwrap(AssemblyTemplate template, EntitySpec<? extends Application> app) {
		    ...
		    private static List<EntitySpec<?>> buildTemplateArtifactsOrServiceAsSpecs(BrooklynClassLoadingContext loader, AssemblyTemplate template, CampPlatform platform, Set<String> encounteredRegisteredTypeIds) {
		    ...
		    private static List<EntitySpec<?>> buildReqSpec(BrooklynClassLoadingContext loader, oCampPlatformComponentTemplate pctl, Set<String> encounteredRegisteredTypeIds){
		    	List<EntitySpec<?>> result = Lists.newArrayList();
		  ...
		  //TODO need to complete this method
		    private static EntitySpec<?> buildTemplateSpecRec(BrooklynClassLoadingContext loader, oCampPlatformComponentTemplate pctl, Set<String> encounteredRegisteredTypeIds){
		    	//List<EntitySpec<?>> result = Lists.newArrayList();
		    	for (ResolvableLink<PlatformComponentTemplate> ctl: pctl.getPlatformComponentTemplates().links()) {
		    		PlatformComponentTemplate appChildComponentTemplate = ctl.resolve();
		    		//should not just launch new instance. need to determine if it was already built.
		    ...
		    private static List<EntitySpec<?>> buildRecSpecs(BrooklynClassLoadingContext loader, oCampPlatformComponentTemplate pctl, Set<String> encounteredRegisteredTypeIds){
		    	List<EntitySpec<?>> result = Lists.newArrayList();
		    	for (ResolvableLink<PlatformComponentTemplate> ctl: pctl.getPlatformComponentTemplates().links()) {
		    		PlatformComponentTemplate appChildComponentTemplate = ctl.resolve();
		    		//should not just launch new instance. need to determine if it was already built.
		    ...
		    private static void resetSpecIfTemplateHasNoExplicitParameters(AssemblyTemplate template, EntitySpec<? extends Application> wrapperSpec) {
		    ...
		    private static EntitySpec<? extends Application> createWrapperApp(AssemblyTemplate template, BrooklynClassLoadingContext loader) {
