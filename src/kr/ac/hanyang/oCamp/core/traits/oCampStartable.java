...
//		public static final ConfigKey<Object> LOCATION = ConfigKeys.newConfigKey(Object.class, "locations",
...
//						+ "or a list of location objects");
		@Override public Void call(ConfigBag parameters) {
			//parameters.put(LOCATION, entity().getManagementContext().getLocationRegistry().getListOfLocationsManaged(parameters.get(LOCATION)));
    ...
    org.apache.brooklyn.api.effector.Effector<Void> STARTUP = Effectors.effector(new MethodEffector<Void>(oCampStartable.class, "startup"))
            ...
            //.parameter(StartUpEffectorBody.LOCATION)
