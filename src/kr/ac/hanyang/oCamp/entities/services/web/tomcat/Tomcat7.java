...
@ImplementedBy(Tomcat7Impl.class)
public interface Tomcat7 extends TomcatServer, BasicOCampService {


	
	@SetFromFlag("version")
    ConfigKey<String> SUGGESTED_VERSION = ConfigKeys.newConfigKeyWithDefault(SoftwareProcess.SUGGESTED_VERSION, "7.0.72");
