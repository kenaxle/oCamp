...
public class ConstraintSet extends AbstractEntity implements INotifiable{
	...
	private List<PolicyConstraintImpl> constraints;
	...
	public static class Builder{
		...
		public Builder(String name){
			this.name = name;
			constraints = new ArrayList<PolicyConstraintImpl>();
		}
	...
	public void addConstraint(PolicyConstraintImpl constraint){
		this.constraints.add(constraint);
	}
	
	public String getName(){ return name;}
	
	public PolicyConstraintImpl getConstraint(PolicyConstraintImpl constraint){
		if (constraint instanceof PolicyConstraintImpl)
	...
	public List<PolicyConstraintImpl> getConstraints(){return constraints;}	
