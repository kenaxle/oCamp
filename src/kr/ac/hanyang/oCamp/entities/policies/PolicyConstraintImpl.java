...
public class PolicyConstraintImpl<T, U> extends AbstractEntity implements PolicyConstraint{
...
//		}
//		
//		public PolicyConstraintImpl build(){
//			return new PolicyConstraintImpl(this);
//		}
//	}
	
	private PolicyConstraintImpl(Builder builder){
		this.enabled = false;
	...
	private SensorEventListener constraintListener(Entity constraint){
		return new SensorEventListener(){
			public void onEvent(SensorEvent event){
				if (!((PolicyConstraintImpl) constraint).evaluateFunction())
					((PolicyConstraintImpl) constraint).notifySubscribers();
			}
		};
	}
