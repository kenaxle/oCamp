...
public class SoftwareImpl<T> extends BasicOCampArtifactImpl<Object> implements Startable, Software{
	private static final Logger log = LoggerFactory.getLogger(SoftwareImpl.class);
